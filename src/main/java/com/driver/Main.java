...
public class Main {
    public static void main(String[] args) throws ParseException {
        ...
        workspace.addMeeting(new Meeting(LocalTime.parse("11:40"), LocalTime.parse("15:00")));
        workspace.addMeeting(new Meeting(LocalTime.parse("15:30"), LocalTime.parse("18:00")));
